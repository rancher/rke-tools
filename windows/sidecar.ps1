...
if ($networkConfigObj) 
{
    switch ($networkConfigObj.plugin)
    {
        "flannel" {
            ...
            } | ConvertTo-Json -Compress -Depth 32 | Out-File -NoNewline -Encoding utf8NoBOM -Force -FilePath "c:\host\etc\cni\net.d\10-flannel.conflist"
...
$cniInfo | ConvertTo-Json -Compress -Depth 32 | Out-File -NoNewline -Encoding utf8NoBOM -Force -FilePath "c:\run\cni-info.json"
...
if ($networkConfigObj) 
{
    switch ($networkConfigObj.plugin) 
    {
        "flannel" {
            ...
            } | ConvertTo-Json -Compress -Depth 32 | Out-File -NoNewline -Encoding utf8NoBOM -Force -FilePath "c:\host\etc\kube-flannel\net-conf.json"
